...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-transparent w-full text-black">
      <div className="rounded-lg shadow-lg w-[926px] h-[711px] LightBgBlue flex flex-col items-center justify-center">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 w-[20rem]">
          ...
          <div className="text-center">
            <Link to="/forgetpassword" className="text-blue-500 underline text-sm">
              Forgot your password?
            </Link>
          </div>
          <Button type='submit' text="Log In" className='w-full cursor-pointer' />
        </form>
        <div className='mt-5'>
